...
import { protect, adminOnly, requireRoles } from '../middlewares/authMiddleware.js';
...
router.post('/quotation-hotel', protect, requireRoles('super_admin', 'admin', 'sales'), createQuotationHotelMediaAsset);
