...
export const getAdminUsers = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error fetching users' });
  }
};
...
export const getAdminUserById = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error fetching user detail' });
  }
};
...
export const createAdminStaffUser = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error creating staff user' });
  }
};
...
export const getAdminBookingById = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error fetching booking detail' });
  }
};
...
export const updateUserRole = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error updating user role' });
  }
};
...
export const updateUserAccountStatus = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error updating account status' });
  }
};
...
export const getInfluencerApplications = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error fetching creator applications' });
  }
};
...
export const getInfluencerApplicationById = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error fetching creator application' });
  }
};
...
export const approveInfluencerApplication = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error approving creator application' });
  }
};
...
export const rejectInfluencerApplication = async (req, res) => {
  try {
    ...
    return res.status(500).json({ success: false, message: error.message || 'Server Error rejecting creator application' });
  }
};
