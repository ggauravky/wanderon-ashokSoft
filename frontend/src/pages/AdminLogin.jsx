...
const AdminLogin = () => {
  const [email, setEmail] = useState('gaurav99@gmail.com');
  const [password, setPassword] = useState('gaurav@99');
  ...
  useEffect(() => {
    if (isAuthenticated && (user?.role === 'admin' || user?.email?.toLowerCase() === 'gaurav99@gmail.com')) {
  ...
  const handleAdminQuickLogin = async () => {
    setLoading(true);
    try {
      await adminLogin('gaurav99@gmail.com', 'gaurav@99');
      setLoading(false);
      navigate('/admin', { replace: true });
    } catch (err) {
      setLoading(false);
      ...
      <div className="max-w-4xl w-full bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20 grid grid-cols-1 md:grid-cols-2 relative z-10">
        ...
        <div className="relative hidden md:flex flex-col justify-between p-10 bg-gradient-to-b from-brand-navy to-gray-900 text-white border-r border-white/10">
          ...
          <div className="pt-8 border-t border-white/10 space-y-3">
            <div className="text-xs text-white/60 font-mono">
              <span className="text-brand-emerald font-bold">Authorized Admin:</span> gaurav99@gmail.com
            </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center text-brand-navy">
          ...
          >
            ...
            1-Click Admin Login (gaurav99@gmail.com)
          </button>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="gaurav99@gmail.com"
