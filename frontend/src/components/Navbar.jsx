        ...
        <div className="travel-container">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link
                to="/plan"
                className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-2xl bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-500 border border-emerald-500/30 text-xs font-black uppercase tracking-wider whitespace-nowrap transition-all cursor-pointer shadow-xs"
              >
