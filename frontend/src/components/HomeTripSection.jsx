 ...
 * 
 * Features:
 * - Side-by-side horizontal scrollable layout with smooth touch and snap scrolling
 * - Desktop & Tablet left/right interactive scroll control buttons
    ...
    <section id={id} className={`travel-section ${bgClass}`}>
      <div className="travel-container">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-end gap-4 mb-6 sm:mb-8">
          ...
          {/* Right Header: Extra Controls (e.g. Month Chips) + Desktop View All Button & Scroll Arrows */}
        ...
        {/* Trips Display: Touch & Scrollable Side-by-Side Row with hidden scrollbars */}
            ...
            >
              {uniqueTrips.map((trip) => (
                <div
                  ...
                  className="w-[82vw] max-w-[300px] sm:w-[280px] md:w-[300px] lg:w-[310px] shrink-0 snap-start flex flex-col"
                >
