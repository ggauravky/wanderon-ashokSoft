...
test('administrators see every department workspace', () => {
  const expected = ['Overview', 'Admin Overview', 'Team Analytics', 'Trips', 'Bookings', 'Media Library', 'Pages', 'Users & Roles', 'Creator Approvals', 'Payouts', 'Discounts', 'Operations Overview', 'Sales Overview', 'Expert Requests', 'Quotations', 'Bookings', 'Marketing Overview', 'Lead & Conversion Analytics', 'Campaigns', 'Banners & Promotions'];
...
test('operations sees only the shared overview and Operations workspace', () => {
  assert.deepEqual(visibleLabels('operations'), ['Overview', 'Operations Overview']);
...
test('all department links stay inside the canonical staff application', () => {
  ...
  assert.deepEqual(workspacePaths, ['/staff/admin', '/staff/admin/team-analytics', '/staff/admin/trips', '/staff/admin/bookings', '/staff/admin/media', '/staff/admin/pages', '/staff/admin/users', '/staff/admin/creators', '/staff/admin/payouts', '/staff/admin/discounts', '/staff/operations', '/staff/sales', '/staff/sales/expert-requests', '/staff/sales/quotations', '/staff/sales/bookings', '/staff/marketing', '/staff/marketing/lead-analytics', '/staff/marketing/campaigns', '/staff/marketing/banners']);
});
