...
import {
  adminApproveQuotationV2Api, createBookingFromQuotationV2Api, createQuotationRevisionV2Api,
...
export default function QuotationV2Detail({ quotation, reload }) {
  ...
  const exportPdf = useCallback(async (documentModel, templateKey, element) => {
    ...
    try {
      ...
      setError('Unable to generate this quotation PDF. Please try again.');
