...
const leadDraft = (lead) => {
  ...
  if (travelerFacts) {
    draft.tripRequirements.adults = Number(travelerFacts.adults || 0);
    ...
    draft.tripRequirements.seniors = Number(travelerFacts.seniors || 0);
  }
  draft.tripRequirements.totalTravelers = Math.max(1, draft.tripRequirements.adults + draft.tripRequirements.children + draft.tripRequirements.infants + draft.tripRequirements.seniors);
